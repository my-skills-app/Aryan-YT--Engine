package com.aryan.yt.engine.services.youtube.dashmanifestcreators;

import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.ALR_YES;
import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.RN_0;
import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SEGMENT_TIMELINE;
import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SQ_0;
import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.buildAndCacheResult;
import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateDocumentAndDoCommonElementsGeneration;
import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTemplateElement;
import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTimelineElement;
import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.getInitializationResponse;
import static com.aryan.yt.engine.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.setAttribute;
import static com.aryan.yt.engine.utils.Utils.isBlank;

import com.aryan.yt.engine.downloader.Response;
import com.aryan.yt.engine.services.youtube.DeliveryType;
import com.aryan.yt.engine.services.youtube.ItagItem;
import com.aryan.yt.engine.utils.ManifestCreatorCache;
