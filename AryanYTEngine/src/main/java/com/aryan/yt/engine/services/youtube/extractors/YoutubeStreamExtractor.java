...
import static com.aryan.yt.engine.services.youtube.ItagItem.APPROX_DURATION_MS_UNKNOWN;
import static com.aryan.yt.engine.services.youtube.ItagItem.CONTENT_LENGTH_UNKNOWN;
import static com.aryan.yt.engine.services.youtube.YoutubeDescriptionHelper.attributedDescriptionToHtml;
import static com.aryan.yt.engine.services.youtube.YoutubeParsingHelper.CONTENT_CHECK_OK;
import static com.aryan.yt.engine.services.youtube.YoutubeParsingHelper.CPN;
import static com.aryan.yt.engine.services.youtube.YoutubeParsingHelper.RACY_CHECK_OK;
import static com.aryan.yt.engine.services.youtube.YoutubeParsingHelper.VIDEO_ID;
import static com.aryan.yt.engine.services.youtube.YoutubeParsingHelper.fixThumbnailUrl;
import static com.aryan.yt.engine.services.youtube.YoutubeParsingHelper.generateContentPlaybackNonce;
import static com.aryan.yt.engine.services.youtube.YoutubeParsingHelper.getImagesFromThumbnailsArray;
...
import static com.aryan.yt.engine.services.youtube.YoutubeParsingHelper.prepareDesktopJsonBuilder;
...
import com.aryan.yt.engine.MediaFormat;
import com.aryan.yt.engine.MetaInfo;
import com.aryan.yt.engine.MultiInfoItemsCollector;
import com.aryan.yt.engine.StreamingService;
import com.aryan.yt.engine.downloader.Downloader;
import com.aryan.yt.engine.exceptions.AccountTerminatedException;
import com.aryan.yt.engine.exceptions.AgeRestrictedContentException;
import com.aryan.yt.engine.exceptions.ContentNotAvailableException;
import com.aryan.yt.engine.exceptions.ExtractionException;
import com.aryan.yt.engine.exceptions.GeographicRestrictionException;
import com.aryan.yt.engine.exceptions.PaidContentException;
import com.aryan.yt.engine.exceptions.ParsingException;
import com.aryan.yt.engine.exceptions.PrivateContentException;
import com.aryan.yt.engine.exceptions.YoutubeMusicPremiumContentException;
import com.aryan.yt.engine.exceptions.SignInConfirmNotBotException;
import com.aryan.yt.engine.linkhandler.LinkHandler;
import com.aryan.yt.engine.localization.ContentCountry;
import com.aryan.yt.engine.localization.DateWrapper;
import com.aryan.yt.engine.localization.Localization;
import com.aryan.yt.engine.localization.TimeAgoParser;
import com.aryan.yt.engine.localization.TimeAgoPatternsManager;
import com.aryan.yt.engine.services.youtube.ItagItem;
import com.aryan.yt.engine.services.youtube.PoTokenProvider;
import com.aryan.yt.engine.services.youtube.PoTokenResult;
import com.aryan.yt.engine.services.youtube.YoutubeJavaScriptPlayerManager;
import com.aryan.yt.engine.services.youtube.YoutubeMetaInfoHelper;
import com.aryan.yt.engine.services.youtube.YoutubeParsingHelper;
import com.aryan.yt.engine.services.youtube.YoutubeStreamHelper;
...
import com.aryan.yt.engine.stream.DeliveryMethod;
import com.aryan.yt.engine.stream.Description;
import com.aryan.yt.engine.stream.Frameset;
import com.aryan.yt.engine.stream.Stream;
import com.aryan.yt.engine.stream.StreamExtractor;
import com.aryan.yt.engine.stream.StreamSegment;
import com.aryan.yt.engine.stream.StreamType;
import com.aryan.yt.engine.stream.SubtitlesStream;
import com.aryan.yt.engine.stream.VideoStream;
import com.aryan.yt.engine.utils.JsonUtils;
import com.aryan.yt.engine.utils.LocaleCompat;
import com.aryan.yt.engine.utils.Pair;
import com.aryan.yt.engine.utils.Parser;
...
public class YoutubeStreamExtractor extends StreamExtractor {
    ...
    public Privacy getPrivacy() {
        return playerMicroFormatRenderer.getBoolean("isUnlisted")
                || JsonUtils.streamAsJsonObjects(getVideoPrimaryInfoRenderer().getArray("badges"))
                .anyMatch(badge ->
