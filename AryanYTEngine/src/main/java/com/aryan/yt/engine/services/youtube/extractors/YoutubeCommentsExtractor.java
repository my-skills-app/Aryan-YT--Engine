...
import com.aryan.yt.engine.comments.CommentsInfoItem;
import com.aryan.yt.engine.comments.CommentsInfoItemsCollector;
        ...
        if (content.has("commentThreadRenderer")) {
            ...
            if (commentThreadRenderer.has(COMMENT_VIEW_MODEL_KEY)) {
                ...
                collector.commit(new YoutubeCommentsEUVMInfoItemExtractor(
                        ...
                        (JsonObject) getMutationPayloadFromEntityKey(mutations,
